...
class TweetAdmin(admin.ModelAdmin):
    fields = ['id', 'id_str', 'status', 'url', 'full_text', 'labels_manual',
              'labels_automatic', 'tweet_group', 'keywords', 'content',
              'created_at', 'updated_at']
    readonly_fields = ['id', 'created_at', 'updated_at']
    list_display = ('id', 'id_str', 'status', 'full_text', 'labels_manual',
                    'created_at', 'updated_at')
    search_fields = ['id', 'id_str', 'status', 'full_text', 'labels_manual',
                     'labels_automatic', 'keywords']
    actions = [finalize_tweets, exclude_tweets, activate_tweets, discuss_tweets]
    list_filter = ['status']


class LabelAdmin(admin.ModelAdmin):
    fields = ['label_name', 'parent_label', 'order', 'label_color', 'shortcut',
              'created_at', 'updated_at']
    readonly_fields = ['created_at', 'updated_at']
    list_display = ('label_name', 'parent_label', 'order', 'label_color',
                    'shortcut', 'created_at', 'updated_at')
